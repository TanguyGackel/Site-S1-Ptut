...
<head>
    <meta charset="UTF-8">
    <title>Projet tutoré : Droit</title>
...
if(isset($_SESSION['langage'])) {
    ...
    include($header);
    $article_principale = 'article/article_droit_' . $langue . '.php';
    ...
    include('article/article_droit_fr.php');
...
<div class="container d-block d-md-none ">
    <div class="row">
        <div class="col-4">
            <a href="page_eco.php">Précédent / Previous</a>
        </div>
        <div class="col-4">
            <a href="page_principale.php">Retourner à l'acceuil</a>
        </div>
        <div class="col-4">
            <a href="page_interview.php">Suivant / Next</a>
        </div>
    </div>
</div>
<?php
