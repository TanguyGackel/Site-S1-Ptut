...
<head>
    <meta charset="UTF-8">
    <title>Projet tutoré: Moteur</title>
...
if(isset($_SESSION['langage'])) {
    ...
    include($header);
    $article_principale = 'article/article_moteur_' . $langue . '.php';
    ...
    include('article/article_moteur_fr.php');
...
<div class="container d-block d-md-none ">
    <div class="row">
        <div class="col-4">
            <a href="page_histoire.php">Précédent / Previous</a>
        </div>
        <div class="col-4">
            <a href="page_principale.php">Retourner à l'acceuil</a>
        </div>
        <div class="col-4">
            <a href="page_unreal_engine.php">Suivant / Next</a>
        </div>
    </div>
</div>
<?php
