...
<head>
    <meta charset="UTF-8">
    <title>Projet tutoré : Exemple</title>
...
if(isset($_SESSION['langage'])) {
    ...
    include($header);
    $article_principale = 'article/article_exemple_' . $langue . '.php';
    ...
    include('article/article_exemple_fr.php');
...
<div class="container d-block d-md-none ">
    <div class="row">
        <div class="col-4">
            <a href="page_unreal_engine.php">Précédent / Previous</a>
        </div>
        <div class="col-4">
            <a href="page_principale.php">Retourner à l'acceuil</a>
        </div>
        <div class="col-4">
            <a href="page_eco.php">Suivant / Next</a>
        </div>
    </div>
</div>
<?php
